...
- **Right-click context menu** on result rows: open URL in browser, copy URL, show details, diet advisor, copy details, export the visible rows as JIRA / JSON / plain text to the clipboard, rescan a single URL, toggle errors-only filter
